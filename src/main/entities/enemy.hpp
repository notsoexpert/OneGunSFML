...
namespace Enemy {
    ...
    constexpr std::array<Specification, Type::Total> Specifications = {
        Specification{{{0, 64}, {64, 64}}, {{-8, -8}, {16, 16}}, 3.0f, 5.0f, 10.0f},  // Asteroid
        Specification{{{64, 64}, {64, 64}}, {{-23, -23}, {46, 46}}, 2.0f, 5.0f, 25.0f}, // LargeAsteroid
        Specification{{{128, 64}, {64, 64}}, {{-32, -32}, {64, 64}}, 1.0f, 5.0f, 50.0f}, // HugeAsteroid
        Specification{{{0, 64}, {64, 64}}, {{0, 0}, {64, 64}}, 6.0f, 2.5f, 100.0f},  // Comet
        Specification{{{192, 64}, {64, 64}}, {{-24, -24}, {48, 48}}, 2.0f, 5.0f, 20.0f, 0.5f},  // Drone
        Specification{{{256, 64}, {64, 64}}, {{-24, -24}, {48, 48}}, 5.0f, 5.0f, 40.0f},  // Fighter
        Specification{{{320, 64}, {64, 64}}, {{-24, -24}, {48, 48}}, 3.0f, 5.0f, 50.0f},  // Bomber
        Specification{{{384, 64}, {64, 64}},  {{0, 0}, {64, 64}}, 6.0f, 3.0f, 150.0f},  // Hunter
